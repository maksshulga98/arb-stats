...
// 04.06.2026: новые вакансии — A "Копирайтер", B "Ведение соц сетей".
// Карина → колонка A (Копирайтер)
// Оля     → колонка B (Ведение соц сетей)
// Команда Анастасии расформирована — удалена из конфига.
