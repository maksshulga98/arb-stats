            ...
            <tbody>
              {history.map(app => (
                <tr key={app.id} style={{ borderTop: '1px solid #f1f5f9' }} className="hover:bg-slate-50 transition">
                  ...
                  {showManagerColumn && (
                    <td className="px-3 sm:px-5 py-3 text-sm text-gray-700">{managerNameById[app.manager_id] || '—'}</td>
                  )}
              ...
              <div>
                <div className="bg-emerald-50 border border-emerald-300 rounded-lg p-4 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <input readOnly value={result.referralLink} className="flex-1 bg-white text-sm text-gray-700 px-3 py-2 rounded-lg border border-gray-300 truncate" />
                    <button
              ...
              <form onSubmit={handleCreate}>
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-1">Если в реестре несколько ИП с одинаковым ФИО — партнёр выберет нужного по ИНН.</p>
                  </div>
                  <div>
